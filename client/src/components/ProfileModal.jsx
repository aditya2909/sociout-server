        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                type="button"
                className="px-4 py-2 bg-linear-to-r text-white rounded-lg from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer"
              >
                Save Changes
              </button>
            </div>
