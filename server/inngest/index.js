...
const sendNewConnectionReminder = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    await step.run("send-connection-request-mail", async () => {
      ...
      <p>Click <a href="${process.env.FRONEND_URL}/connections" style="color: #10b981;" >here</a> to accept or reject the request</p>
      <br />
      <p>Thanks, <br/> Sociout - Stay Connected</p>
      </div>`;
      await sendEmail({
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    for (const userId in unseenCount) {
      ...
      <p>Click <a href="${process.env.FRONEND_URL}/connections" style="color: #10b981;" >here</a> to view them</p>
      <br />
      <p>Thanks, <br/> Sociout - Stay Connected</p>
      </div>`;
